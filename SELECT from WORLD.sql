...
#8 ~~Exclusive OR (XOR). Show the countries that are big by area (more than 3 mill) or big by population (more than 250 mill) but not both. 
...
SELECT name, capital FROM world
WHERE LEFT(name,1)=LEFT(capital,1) AND !=capital;
